export default function Lab1() {
  ...
  <ol id="wd-your-favorite-recipe">
    <li>Peel russet potatoes.</li>
    <li>Peel garlic.</li>
    <li>Cut potatoes into fourths.</li>
    <li>Put potatoes and garlic into a pot of water that is about an inch higher than the highest potato.</li>
    <li>Boil potatoes and garlic for 15~20 minutes (Lean towards 20).</li>
    <li>Partially mash potatoes.</li>
    <li>Add a stick of butter, salt, pepper, and a small amount of sour cream.</li>
    <li>Continue to mash potatoes.</li>
    <li>Eat mashed potatoes.</li>
  </ol>
